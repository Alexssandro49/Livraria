...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PERMISSION_CLASSES": ("rest_framework.permissions.DjangoModelPermissionsOrAnonReadOnly", ),  # autorização de acesso"DEFAULT_PAGINATION_CLASS": "rest_framework.pagination.PageNumberPagination",
